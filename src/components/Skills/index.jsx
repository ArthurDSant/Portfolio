...
import { SiReact, SiRedux, SiPowerbi } from "react-icons/si";
  ...
  return (
    <div>
      ...
      <div className='skill shadow'>
          <SiPowerbi className="three" alt="Data Science"/>
            ...
            <div className="link">
              <a href="https://github.com/ArthurDSant/BI-Sales_Management" target='_blank' aria-label="gitHub">One project with<RiShareBoxLine /></a>
            </div>
          </div>

          <div className='skill shadow'>
            <FaPython className="four" alt="API's"/>
            ...
            <div className="link">
              <a href="https://github.com/ArthurDSant/API-RestFull" target='_blank' aria-label="gitHub">One project with<RiShareBoxLine /></a>
            </div>
          </div>
          ...
          <div className='skill shadow'>
            ...
            <div className="link">
              <a href="https://github.com/ArthurDSant/BeatsByDre" target='_blank' aria-label="gitHub">One project with<RiShareBoxLine /></a>
            </div>
          </div>
